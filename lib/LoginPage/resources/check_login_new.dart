...
//         for (int i = 0; i < data1['data']['students'].length; i++) {
//           if (data1['data']['students'][i]['status'] == true) {
//             var userName = data1['data']['students'][i]['name'];
//             var userRole = "PARENT";
//             var userToken = authToken;
//             var userId = data1['data']['students'][i]['_id'];
//             var classId = data1['data']['students'][i]['classId'];
//             var sectionId = data1['data']['students'][i]['sectionId'];
//             var studentPic = data1['data']['students'][i]['profilePicUrl'];
...
//                     parentId, classId, sectionId, studentPic, mPin, pinExist)
//                 .then((val) {
...
//             break;
//           }
//           if (i == data1['data']['students'].length - 1 &&
//               data1['data']['students'][i]['status'] == false) {
//             showDialogSingleButton(
//                 context, "", "Your ward status has been disabled", "Ok");
//           }
//         }
//       } else {
//         showDialogSingleButton(
