...
class _ResultPageState extends State<ResultPage> {
  ...
  Widget build(BuildContext context) {
    ...
    resultBloc.fetchAllResult(
        context, widget.userToken, widget.studentId, widget.sectionId);
                ...
                Expanded(
                  child: ListTile(
                    leading: CircleAvatar(
                      ...
                      radius: cWidth * 0.05,
                      child: new Text(
                        snapshot.data.data[index].id.toString().substring(0, 1),
                        style: new TextStyle(
                          fontSize: cHeight * 0.04, //cHeight * 0.02,
                    ...
                    title: Row(
                      children: <Widget>[
                        ...
                        new Text(
                          snapshot.data.data[index].percentage
                                      .toString()
                                      .length >
                                  5
                              ? snapshot.data.data[index].percentage
                                  .toString()
                                  .substring(0, 5)
                              : snapshot.data.data[index].percentage.toString(),
                          style: new TextStyle(
                            fontSize: 18, //cHeight * 0.02,
                            fontWeight: FontWeight.w400,
                          ),
