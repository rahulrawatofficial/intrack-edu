...
class Newnoon extends StatefulWidget {
  Newnoon({Key key, this.timeTable}) : super(key: key);

  final TimeTableModel timeTable;
  @override
  _NewnoonState createState() => _NewnoonState();
}
...
class _NewnoonState extends State<Newnoon> {
  double cHieght;
  double cWidth;
  Color color1;
  ...
  Widget build(BuildContext context) {
    ...
    if (myTimeTable == null) {
      ...
      List<dynamic> timeInList1 = new List(12);
      List<dynamic> timeOutList1 = new List(12);
          ...
          children: <Widget>[
            ...
            new ListView.builder(
              ...
              itemBuilder: (BuildContext context1, int index1) {
                ...
                List<dynamic> lecture = new List(12);
                List<dynamic> timeInList = new List(12);
                List<dynamic> timeOutList = new List(12);
        ...
        child: Padding(
          ...
          child: new Row(
            children: <Widget>[
              ...
              lectures[8] != null
                  ? subjectContainer(lectures[8].toString())
                  : Offstage(),
              lectures[9] != null
                  ? subjectContainer(lectures[9].toString())
                  : Offstage(),
              lectures[10] != null
                  ? subjectContainer(lectures[10].toString())
                  : Offstage(),
              lectures[11] != null
                  ? subjectContainer(lectures[11].toString())
                  : Offstage(),
            ],
          ),
        ),
      ...
      child: Padding(
        ...
        child: new Row(
          children: <Widget>[
            ...
            periodContainer("9", timeIn[8]),
            periodContainer("10", timeIn[9]),
            periodContainer("11", timeIn[10]),
            periodContainer("12", timeIn[11])
          ],
        ),
      ),
    );
