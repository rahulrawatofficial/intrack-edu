          ...
          children: <Widget>[
            ...
            new ListView.builder(
              ...
              itemCount: myTimeTable == null
                  ? 0
                  : myTimeTable.data.schedule[0] == null
                      ? 0
        ...
        child: Padding(
          ...
          child: new Row(
            children: <Widget>[
              ...
              lectures[0] != null
                  ? subjectContainer(lectures[0].toString())
                  : Offstage(),
              lectures[1] != null
                  ? subjectContainer(lectures[1].toString())
                  : Offstage(),
              lectures[2] != null
                  ? subjectContainer(lectures[2].toString())
                  : Offstage(),
              lectures[3] != null
                  ? subjectContainer(lectures[3].toString())
                  : Offstage(),
            ],
          ),
        ),
      ...
      child: Padding(
        ...
        child: new Row(
          children: <Widget>[
            ...
            periodContainer("1", timeIn[0]),
            periodContainer("2", timeIn[1]),
            periodContainer("3", timeIn[2]),
            periodContainer("4", timeIn[3]),
          ],
        ),
      ),
    );
