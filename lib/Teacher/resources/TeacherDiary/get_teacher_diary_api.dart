...
class GetTeacherDiaryApi {
  Future<GetTeacherDiaryModel> getDiary(
      String userToken, BuildContext context) async {
    String path = "/v1/getDiaryListOfTeacher";
    print("entered");
    ...
    if (response.statusCode == 200) {
      ...
      return GetTeacherDiaryModel.fromJson(json.decode(response.body));
