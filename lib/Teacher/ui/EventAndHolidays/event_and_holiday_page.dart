...
import 'package:intrack/Teacher/ui/EventAndHolidays/school_event_page.dart';
import 'package:intrack/Teacher/ui/EventAndHolidays/school_holiday_page.dart';

class TeacherEventHolidayPage extends StatefulWidget {
  final String userToken;
  final String studentId;
  TeacherEventHolidayPage({
    Key key,
    this.userToken,
    this.studentId,
  }) : super(key: key);
  @override
  _TeacherEventHolidayPageState createState() =>
      _TeacherEventHolidayPageState();
}

// _InternalLinkedHashMap<String, dynamic> jk;
TimeTableModel timeTable;

class _TeacherEventHolidayPageState extends State<TeacherEventHolidayPage> {
