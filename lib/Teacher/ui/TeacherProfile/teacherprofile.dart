...
import 'package:intrack/Teacher/ui/TeacherProfile/edit_teacher_profile.dart';
...
class TeacherProfile extends StatefulWidget {
  ...
  TeacherProfile({Key key, this.userToken, this.userId, this.teacherPic})
      : super(key: key);
  @override
...
class _TeacherProfileState extends State<TeacherProfile> {
  ...
  String url = "https://api-dashboard.intrack.in/v1/teacherChangePassword";
                      ...
                      Column(
                        children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: CircleAvatar(
                                    backgroundImage: widget.teacherPic != null
                                        ...
                                        : AssetImage("assets/demoteacher.jpg"),
                                    backgroundColor: Color(0xFFFF6144),
                                    radius: cHeight * 0.08,
                                  ),
                                ),
                          ...
                          ListTile(
                            onTap: () {
                              logOut();
                              teacherLogout(widget.userToken);
