...
//
//     final teacherSyllabusListModel = teacherSyllabusListModelFromJson(jsonString);

import 'dart:convert';

TeacherSyllabusListModel teacherSyllabusListModelFromJson(String str) =>
    TeacherSyllabusListModel.fromJson(json.decode(str));

String teacherSyllabusListModelToJson(TeacherSyllabusListModel data) =>
    json.encode(data.toJson());

class TeacherSyllabusListModel {
  bool success;
  String message;
  List<Datum> data;

  TeacherSyllabusListModel({
    this.success,
    this.message,
    this.data,
  });

  factory TeacherSyllabusListModel.fromJson(Map<String, dynamic> json) =>
      TeacherSyllabusListModel(
